## File name to use in search: read_data_run_statistical_model_full_gender_regions.R ##
...
# multinomial probit, gender and region model
...
stargazer(mprobit1, type = "html", out = args$output[[2]])
